...
from lib.models import MY_OCEAN_BASELINE_KANATTN_RBF_V2
from lib.utils import reduce_tensor
from .base_method import Base_method


class MY_BASELINE_KANATTN_RBF_V2(Base_method):
    ...
    def _build_model(self, args):
        return MY_OCEAN_BASELINE_KANATTN_RBF_V2(**args).to(self.device)
