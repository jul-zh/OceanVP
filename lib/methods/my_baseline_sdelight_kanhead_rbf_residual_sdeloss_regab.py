...
class MY_BASELINE_SDELIGHT_KANHEAD_RBF_RESIDUAL_SDELOSS_REGAB(Base_method):
    def __init__(self, args, device, steps_per_epoch):
        ...
        self.sde_alpha = getattr(args, "sde_alpha", 0.1051857)
        self.sde_beta = getattr(args, "sde_beta", 6.1e-05)
