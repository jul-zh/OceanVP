...
from lib.models import MY_OCEAN_BASELINE_STRONGENC_KANHEAD_RBF_RESIDUAL
from lib.utils import reduce_tensor
from .base_method import Base_method


class MY_BASELINE_STRONGENC_KANHEAD_RBF_RESIDUAL(Base_method):
    ...
    def _build_model(self, args):
        return MY_OCEAN_BASELINE_STRONGENC_KANHEAD_RBF_RESIDUAL(**args).to(self.device)
    ...
    def train_one_epoch(self, runner, train_loader, epoch, num_updates, eta=None, **kwargs):
        ...
        for batch_x, batch_y in train_pbar:
            ...
            if self.rank == 0:
                train_pbar.set_description(f"train loss: {loss.item():.4f} | data time: {data_time_m.avg:.4f}")
