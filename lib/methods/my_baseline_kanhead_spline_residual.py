...
from lib.models import MY_OCEAN_BASELINE_KANHEAD_SPLINE_RESIDUAL
from lib.utils import reduce_tensor
from .base_method import Base_method


class MY_BASELINE_KANHEAD_SPLINE_RESIDUAL(Base_method):
    ...
    def _build_model(self, args):
        return MY_OCEAN_BASELINE_KANHEAD_SPLINE_RESIDUAL(**args).to(self.device)
