...
from lib.models import MY_OCEAN_BASELINE_SDELIGHT_KANHEAD_RBF_RESIDUAL_TEMPMIX
from lib.utils import reduce_tensor
from .base_method import Base_method


class MY_BASELINE_SDELIGHT_KANHEAD_RBF_RESIDUAL_TEMPMIX_SDELOSS_BINS(Base_method):
    ...
    def _build_model(self, args):
        return MY_OCEAN_BASELINE_SDELIGHT_KANHEAD_RBF_RESIDUAL_TEMPMIX(**args).to(self.device)
