...
from lib.models import MY_OCEAN_BASELINE_SDELIGHT_KANHEAD_RBF_RESIDUAL_STEMPLUS
from lib.utils import reduce_tensor
from .base_method import Base_method


class MY_BASELINE_SDELIGHT_KANHEAD_RBF_RESIDUAL_STEMPLUS_SDELOSS_BINS(Base_method):
    ...
    def _build_model(self, args):
        return MY_OCEAN_BASELINE_SDELIGHT_KANHEAD_RBF_RESIDUAL_STEMPLUS(**args).to(self.device)
