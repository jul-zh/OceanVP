...
from lib.models import MY_OCEAN_BASELINE_KANHEAD_SPLINE
from lib.utils import reduce_tensor
from .base_method import Base_method


class MY_BASELINE_KANHEAD_SPLINE(Base_method):
    ...
    def _build_model(self, args):
        return MY_OCEAN_BASELINE_KANHEAD_SPLINE(**args).to(self.device)
