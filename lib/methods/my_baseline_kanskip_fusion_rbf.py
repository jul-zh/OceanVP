...
from lib.models import MY_OCEAN_BASELINE_KANSKIP_FUSION_RBF
from lib.utils import reduce_tensor
from .base_method import Base_method


class MY_BASELINE_KANSKIP_FUSION_RBF(Base_method):
    ...
    def _build_model(self, args):
        return MY_OCEAN_BASELINE_KANSKIP_FUSION_RBF(**args).to(self.device)
