...
from lib.models import MY_OCEAN_BASELINE_KANDECODER_GATE_RBF
from lib.utils import reduce_tensor
from .base_method import Base_method


class MY_BASELINE_KANDECODER_GATE_RBF(Base_method):
    ...
    def _build_model(self, args):
        return MY_OCEAN_BASELINE_KANDECODER_GATE_RBF(**args).to(self.device)
