...
class MY_BASELINE_SDELIGHT_KANHEAD_RBF_RESIDUAL_SDELOSS_BINS_HUBER(Base_method):
    def __init__(self, args, device, steps_per_epoch):
        ...
        self.huber_criterion = nn.SmoothL1Loss(beta=getattr(args, "huber_delta", 0.05))
        self.criterion = self.mse_criterion

        self.lambda_huber = getattr(args, "lambda_huber", 0.2)
