...
class SmallDecoderGatedKAN(nn.Module):
    def __init__(
        self,
        hidden_dim=32,
        out_steps=16,
        ...
        self.gate = nn.Sequential(
            ...
            nn.SiLU(),
            nn.Conv2d(32, total_out, kernel_size=1),
            nn.Sigmoid(),
        )
    ...
    def forward(self, x, skip):
        ...
        return out_base + gate * out_kan


class MY_OCEAN_BASELINE_SDELIGHT_KANHEAD_RBF_RESIDUAL_GATEDKAN(nn.Module):
    def __init__(
        self,
        in_shape,
        hid_S=32,
        ...
        **kwargs
        ...
        self.decoder = SmallDecoderGatedKAN(
            hidden_dim=hid_S,
