...
class SmallDecoderKANHeadResidual(nn.Module):
    def __init__(
        self,
        hidden_dim=32,
        out_steps=16,
...
class MY_OCEAN_BASELINE_SDELIGHT_KANHEAD_RBF_RESIDUAL(nn.Module):
    def __init__(
        self,
        in_shape,
        hid_S=32,
        ...
        **kwargs,
        ...
        self.decoder = SmallDecoderKANHeadResidual(
            hidden_dim=hid_S,
    ...
    def _build_sde_features(self, x_raw):
        ...
        return torch.stack(feats, dim=1)  # [B,T,3,H,W]
