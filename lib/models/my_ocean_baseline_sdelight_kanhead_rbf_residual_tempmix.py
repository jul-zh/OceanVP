...
class TemporalMixAttentionPool(nn.Module):
...
class SmallDecoderKANResidual(nn.Module):
    def __init__(
        self,
        hidden_dim=32,
        out_steps=16,
...
class MY_OCEAN_BASELINE_SDELIGHT_KANHEAD_RBF_RESIDUAL_TEMPMIX(nn.Module):
    def __init__(
        self,
        in_shape,
        hid_S=32,
        ...
        **kwargs
        ...
        self.temporal = TemporalMixAttentionPool(dim=hid_S)
        self.decoder = SmallDecoderKANResidual(
            hidden_dim=hid_S,
