...
class MY_OCEAN_BASELINE_STRONGENC_SDELIGHT_KANHEAD_RBF_RESIDUAL(nn.Module):
    def __init__(self, in_shape, hid_S=32, aft_seq_length=16,
        ...
        self.encoder = StrongEncoder(in_channels=3, hidden_dim=hid_S)
    ...
    def forward(self, x_raw, **kwargs):
        ...
        for t in range(T):
            feat, s1, s2 = self.encoder(x_feat[:, t])
