...
echo "=== train start (kanhead rbf residual 50ep) ==="
python tools/train.py \
    -d ocean_t0_32_64 \
    -c configs/ocean/t0_32_64/MY_BASELINE_KANHEAD_RBF_RESIDUAL_50ep.py \
    --ex_name my_baseline_kanhead_rbf_residual_login_50ep \
    --temp_stride 2 \
    --epoch 50
