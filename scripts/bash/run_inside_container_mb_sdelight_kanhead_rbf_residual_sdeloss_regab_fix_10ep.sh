...
echo "=== train start (mb sdelight kanhead rbf residual sdeloss regab fix 10ep) ==="
python tools/train.py \
    -d ocean_t0_32_64 \
    -c configs/ocean/t0_32_64/MY_BASELINE_SDELIGHT_KANHEAD_RBF_RESIDUAL_SDELOSS_REGAB_10ep.py \
    --ex_name mb_sdelight_kanhead_rbf_residual_sdeloss_regab_fix_10ep \
    --temp_stride 2 \
    --epoch 10
