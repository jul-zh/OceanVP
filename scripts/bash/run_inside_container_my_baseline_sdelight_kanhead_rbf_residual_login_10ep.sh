...
echo "=== train start (sdelight + kanhead rbf residual 10ep) ==="
python tools/train.py \
    -d ocean_t0_32_64 \
    -c configs/ocean/t0_32_64/MY_BASELINE_SDELIGHT_KANHEAD_RBF_RESIDUAL.py \
    --ex_name my_baseline_sdelight_kanhead_rbf_residual_login_10ep \
    --temp_stride 2 \
    --epoch 10
