...
echo "=== train start (mb sdelight kanhead rbf residual sdeenergy bins fix 50ep) ==="
python tools/train.py \
    -d ocean_t0_32_64 \
    -c configs/ocean/t0_32_64/MY_BASELINE_SDELIGHT_KANHEAD_RBF_RESIDUAL_SDEENERGY_BINS_50ep_WIDE.py \
    --ex_name mb_sdelight_kanhead_rbf_residual_sdeenergy_bins_fix_50ep \
    --temp_stride 2 \
    --epoch 50
