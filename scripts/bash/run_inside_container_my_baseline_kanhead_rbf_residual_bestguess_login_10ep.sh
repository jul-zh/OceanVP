...
echo "=== train start (rbf residual bestguess 10ep) ==="
python tools/train.py \
    -d ocean_t0_32_64 \
    -c configs/ocean/t0_32_64/MY_BASELINE_KANHEAD_RBF_RESIDUAL_BESTGUESS.py \
    --ex_name my_baseline_kanhead_rbf_residual_bestguess_login_10ep \
    --temp_stride 2 \
    --epoch 10
