...
echo "=== train start (mb sdelight kanhead rbf residual sdeloss bins v2 fix 50ep) ==="
python tools/train.py \
    -d ocean_t0_32_64 \
    -c configs/ocean/t0_32_64/MY_BASELINE_SDELIGHT_KANHEAD_RBF_RESIDUAL_SDELOSS_BINS_V2_10ep.py \
    --ex_name mb_sdelight_kanhead_rbf_residual_sdeloss_bins_v2_fix_50ep \
    --temp_stride 2 \
    --epoch 50
