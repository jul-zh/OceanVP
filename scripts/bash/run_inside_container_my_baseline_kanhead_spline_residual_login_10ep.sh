...
echo "=== train start (kanhead spline residual 10ep) ==="
python tools/train.py \
    -d ocean_t0_32_64 \
    -c configs/ocean/t0_32_64/MY_BASELINE_KANHEAD_SPLINE_RESIDUAL.py \
    --ex_name my_baseline_kanhead_spline_residual_login_10ep \
    --temp_stride 2 \
    --epoch 10
