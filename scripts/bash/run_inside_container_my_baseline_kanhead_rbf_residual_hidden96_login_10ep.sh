...
echo "=== train start (rbf residual hidden96 10ep) ==="
python tools/train.py \
    -d ocean_t0_32_64 \
    -c configs/ocean/t0_32_64/MY_BASELINE_KANHEAD_RBF_RESIDUAL_HIDDEN96.py \
    --ex_name my_baseline_kanhead_rbf_residual_hidden96_login_10ep \
    --temp_stride 2 \
    --epoch 10
