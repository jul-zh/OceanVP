...
echo "=== train start (kandecoder gate rbf 10ep) ==="
python tools/train.py \
    -d ocean_t0_32_64 \
    -c configs/ocean/t0_32_64/MY_BASELINE_KANDECODER_GATE_RBF.py \
    --ex_name my_baseline_kandecoder_gate_rbf_login_10ep \
    --temp_stride 2 \
    --epoch 10
